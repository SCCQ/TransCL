...
#include <sys/time.h>
#include "nkapi.h"
#include "needle_kernel.cu.out.h"


unsigned int totalKernelTime = 0;
unsigned int totalKernelTime_2 = 0;
...
int main( int argc, char** argv) 
{
  ...
  printf("WG size of kernel = %d \n", BLOCK_SIZE);
    ...
    printf("Time for OPENCL kernels_2:\t%f sec\n",totalKernelTime_2 * 1e-6);
    return EXIT_SUCCESS;
}
...
void runTest( int argc, char** argv) 
{
	...
	CUdeviceptr *matrix_cuda,  *referrence_cuda;
	int size;
	...
	for( int i = 1 ; i <= block_width ; i++){
        ...
        ocl_kernel_prop prop_1 = needle_cuda_shared_1();
        std::pair<void*, unsigned long long> fuc1((void*)referrence_cuda, sizeof(int) * size);
        std::pair<void*, unsigned long long> fuc2((void*)matrix_cuda, sizeof(int) * size);
        void *param_1[] = {(void*)&fuc1, (void*)&fuc2, (void*)&max_cols, (void*)&penalty,
        (void*)&i, (void*)&block_width};
	...
	for( int i = block_width - 1  ; i >= 1 ; i--){
		...
		/* needle_cuda_shared_2<<<dimGrid, dimBlock>>>(referrence_cuda, matrix_cuda
		                                      ,max_cols, penalty, i, block_width);  */
        ocl_kernel_prop prop_1 = needle_cuda_shared_2();
        std::pair<void*, unsigned long long> fuc1((void*)referrence_cuda, sizeof(int) * size);
        std::pair<void*, unsigned long long> fuc2((void*)matrix_cuda, sizeof(int) * size);
        void *param_1[] = {(void*)&fuc1, (void*)&fuc2, (void*)&max_cols, (void*)&penalty,
        (void*)&i, (void*)&block_width};
    ...
    totalKernelTime_2 = (time_end_2.tv_sec * 1000000 + time_end_2.tv_usec) - (time_start_2.tv_sec * 1000000 + time_start_2.tv_usec);
